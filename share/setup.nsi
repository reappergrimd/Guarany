...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER Guarany
!define MUI_FINISHPAGE_RUN $INSTDIR\guarany-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall Guarany.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Guarany.lnk"
    Delete /REBOOTOK "$SMSTARTUP\Guarany.lnk"
