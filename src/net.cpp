...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Guarany " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"seed1.guarany.co", "seed1.guarany.co"},
	{"seed2.guarany.co", "seed2.guarany.co"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Guarany is probably already running."), addrBind.ToString().c_str());
        else
