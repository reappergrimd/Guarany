    ...
    model(0)
{
    ...
    ui->sendButton->setIcon(QIcon());
     ...
     ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Guarany address"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    //aQMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm send coins"),
    //      tr("Are you sure you want to send %1?").arg(formatted.join(tr(" and "))),
    //      QMessageBox::Yes|QMessageBox::Cancel,
    //      QMessageBox::Cancel);

    QMessageBox msgBox;
    msgBox.setWindowTitle(tr("Confirm send coins"));
    msgBox.setText(tr("Are you sure you want to send %1?").arg(formatted.join(tr(" and "))));
