...
qApp->setPalette(palette); 
...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/logo_up"));
    setWindowIcon(QIcon(":icons/logo_up"));
#else
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #0d506f; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #0d506f, stop: 1 #0d506f); border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Guarany address"));
    ...
    chatAction = new QAction(QIcon(":/icons/chat"), tr("&"), this);
    chatAction->setToolTip(tr("View chat"));
    chatAction->setCheckable(true);
    tabGroup->addAction(chatAction);

    poolAction = new QAction(QIcon(":/icons/markets"), tr("&"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Guarany"), this);
    aboutAction->setToolTip(tr("Show information about Guarany"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Guarany"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    appMenuBar = new QMenuBar("{ background-color: #0d506f; }");
#else
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Guarany client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Guarany client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Guarany network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Guarany address or malformed URI parameters."));
    }
