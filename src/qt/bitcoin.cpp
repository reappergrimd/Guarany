...
int main(int argc, char *argv[])
{
    ...
    QApplication::setOrganizationName("Guarany");
    QApplication::setOrganizationDomain("guarany.com");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Guarany-Qt-testnet");
    else
        QApplication::setApplicationName("Guarany-Qt");
