...
unsigned int nStakeMaxAge = 60 * 60 * 24 * 7;	// 7 days max stake
unsigned int nStakeTargetSpacing = 2.5 * 60;			// 60 sec block spacing

int64 nChainStartTime = 1414005487;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	else if (pindexBest->nHeight >= 11 && pindexBest->nHeight <= 10000000)
	{
	nSubsidy = 1 * COIN;
    }
...
const int YEARLY_BLOCKCOUNT = 210240;	// 365 * 2880 
...
static const int64 nTargetTimespan = 2.5 * 60;  // 10 blocks
static const int64 nTargetSpacingWorkMax = 2.5 * nStakeTargetSpacing; 
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Guarany
    bool fStrictPayToScriptHash = true; // Always active in Guarany
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Guarany", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Criando o bloco genesis da Guarany";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x4e847aec4c4c27903928868a504c0e71ed40fef25eaa1a13d1991d936e4d3d3d"));
...
unsigned char pchMessageStart[4] = { 0xd3, 0xf1, 0xa4, 0x9f };
